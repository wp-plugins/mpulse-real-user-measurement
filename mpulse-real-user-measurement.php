...
function mpulse_plugin_page() {
	...
	if (isset($_POST['submit'])) {
        ...
        ?><div id="footer" class="soasta_footer"> <p>Your key has been updated.</p></div><?php
	}
...
<p>Please enter your API KEY below. This can be found in your domain configuration within mPulse. If you do not yet have an mPulse account, you can set this up <a href="http://www.soasta.com/free" target="new">here.</a> (For FREE!).</p>
